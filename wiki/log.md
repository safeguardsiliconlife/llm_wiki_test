...
## [2026-04-20] ingest | Figma's Woes Compound with Claude Design
Ingested Martin Alderson blog post (2026-04-18) on Figma's structural AI vulnerability and Claude Design's competitive impact. Created summary page with analysis of inference/headcount asymmetry dynamics. Created entity pages for Figma, Claude Design, and Martin Alderson. Created concept page for SaaSpocalypse.

## [2026-04-20] ingest | Qwen3.6-Max-Preview
Ingested Qwen Team blog post (2026-04-17) announcing Qwen3.6-Max-Preview. Created summary page with benchmark deltas over Qwen3.6-Plus. Created entity pages for Qwen Team and Alibaba Cloud Model Studio. Created concept stub for Agentic Coding.
